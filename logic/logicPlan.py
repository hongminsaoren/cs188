...
def pacphysicsAxioms(t: int, all_coords: List[Tuple], non_outer_wall_coords: List[Tuple], walls_grid: List[List] = None,
    ...
    pacphysics_sentences.append(exactlyOne(lst_position))
    lst_action = []
    for direction in DIRECTIONS:
        lst_action.append(PropSymbolExpr(direction, time=t))
    pacphysics_sentences.append(exactlyOne(lst_action))
    if sensorModel:
